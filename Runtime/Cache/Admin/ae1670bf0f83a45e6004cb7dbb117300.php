...
<div class="page-header">
    <h1><i class="fa fa-home"></i> 首页 &gt;菜单管理</h1>
</div>
<div class="col-xs-12">
    <div class="tabbable">
        ...
        <div class="tab-content">
            <form class="" action="<?php echo U('Admin/Nav/order');?>" method="post">
                ...
                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                    ...
                    <td>
                        <a href="javascript:;" navid="<?php echo ($v['id']); ?>" navname="<?php echo ($v['name']); ?>" onclick="add_child(this)">添加子菜单</a> | <a href="javascript:;" navid="<?php echo ($v['id']); ?>" navname="<?php echo ($v['name']); ?>" navmca="<?php echo ($v['mca']); ?>" navico="<?php echo ($v['ico']); ?>" onclick="edit(this)">修改</a> | <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Nav/delete',array('id'=>$v['id']));?>'">删除</a>
                    </td>
            ...
            <div class="modal-body">
                <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Nav/add');?>" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input-medium" type="text" name="mca"> 输入模块/控制器/方法即可 例如 Admin/Nav/index
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input class="input-medium" type="text" name="ico"> font-awesome图标 输入fa fa- 后边的即可
                        </td>
                    </tr>
                    <tr>
                        <th>
