                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="xb-icheck" type="radio" name="order_status" value="2" checked="checked" /><br/><br/>
                                            <span class="inputword">
                                                退货
                                            </span>
                                            <input class="xb-icheck" type="radio" name="order_status" value="3" /><br/><br/>
                                            <span class="inputword">
                                                (提示：系统默认选择签收，如实际签收后，请点击确定按钮进行状态确认)
                                            </span>
                                        </td>
                                    </tr>
