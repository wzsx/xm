                ...
                <form class="form-inline" method="post">
                    ...
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        <tr>
                            ...
                            <td>
                                <?php if(is_array($data)): foreach($data as $key=>$v): echo ($v['title']); ?>
                                    <input class="xb-icheck" type="radio" name="group_ids[]" value="<?php echo ($v['id']); ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="input-medium" type="text" name="phone" value="<?php echo ($user_data['phone']); ?>">
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="xb-icheck" type="radio" name="isleader" value="1" <?php if(($user_data['isleader']) == "1"): ?>checked="checked"<?php endif; ?>
                                > &emsp;
                                <span class="inputword">
                                    否
                                </span>
                                <input class="xb-icheck" type="radio" name="isleader" value="2" <?php if(($user_data['isleader']) == "2"): ?>checked="checked"<?php endif; ?>
                                >
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="xb-icheck" type="radio" name="status" value="2" <?php if(($user_data['status']) == "2"): ?>checked="checked"<?php endif; ?>
                                >
                            </td>
                        </tr>
                        <tr>
