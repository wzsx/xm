                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                            ...
                            <td>
                                ...
                                |
                                <?php if($v['id'] != 1): ?><a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Rule/delete_group',array('id'=>$v['id']));?>'">删除</a><?php else: ?>
                                <span title="系统管理员，禁止删除">----</span><?php endif; ?>
                             <!--    <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Rule/delete_group',array('id'=>$v['id']));?>'">
                                    删除
                                </a> -->
                                |
                                ...
                                <!-- |
                                <a href="<?php echo U('Admin/Rule/check_user',array('group_id'=>$v['id']));?>">
                                    添加成员
                                </a> -->
                            </td>
